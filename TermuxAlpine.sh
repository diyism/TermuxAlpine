...
addresolvconf
exec proot --link2symlink -0 -r \${PREFIX}/share/TermuxAlpine/ -b \${PREFIX}/share/TermuxAlpine/tmp:/dev/shm -b /dev/ -b /sys/ -b /proc/ -b /sdcard -b /storage -b \$HOME -w /home /usr/bin/env TMPDIR=/tmp HOME=/home PREFIX=/usr SHELL=/bin/sh TERM="\$TERM" LANG=\$LANG PATH=/bin:/usr/bin:/sbin:/usr/sbin /bin/sh --login
EOM
